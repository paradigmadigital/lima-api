...
class LimaSettings(BaseSettings):
    ...
    [httpx.HTTPTransport or httpx.AsyncHTTPTransport](https://www.python-httpx.org/advanced/transports/)
    """
    ...
    ```
    Number of seconds used in timeout parameter of [httpx.Client or httpx.AsyncClient](https://www.python-httpx.org/advanced/timeouts/)
    """
